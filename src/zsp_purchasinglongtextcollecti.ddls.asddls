/********** GENERATED on 03/13/2023 at 16:14:27 by CB9980000011**************/
 @OData.entitySet.name: 'SP_PurchasingLongtextCollection' 
 @OData.entityType.name: 'SP_PurchasingLongtext' 
 define root abstract entity ZSP_PURCHASINGLONGTEXTCOLLECTI { 
 key TEXT_ID : abap.char( 4 ) ; 
 key LANGU : abap.char( 2 ) ; 
 key BP_GUID : abap.raw( 16 ) ; 
 key ASSIGNMENT_ID : abap.char( 12 ) ; 
 key EKORG : abap.char( 4 ) ; 
...
//On-condition is not relevant for runtime 
 _ChangeData1234567891011121374 : association [0..*] to ZCHANGEDATACOLLECTION on 1 = 1; 
 } 
