/********** GENERATED on 03/13/2023 at 16:13:49 by CB9980000011**************/
 @OData.entitySet.name: 'BP_WorkplaceCommFaxCollection' 
 @OData.entityType.name: 'BP_WorkplaceCommFax' 
 define root abstract entity ZBP_WORKPLACECOMMFAXCOLLECTION { 
 ...
 @Odata.property.valueControl: 'FAX__TXT_vc' 
 FAX__TXT : abap.char( 60 ) ; 
 FAX__TXT_vc : RAP_CP_ODATA_VALUE_CONTROL ; 
 
 @OData.property.name: 'ChangeData' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _ChangeData1234567891011121336 : association [0..*] to ZCHANGEDATACOLLECTION on 1 = 1; 
 } 
