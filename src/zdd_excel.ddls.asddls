...
@EndUserText.label: 'Customer Mass upload'
define root view entity ZDD_EXCEL as select from ztab_clap1
{
    key zcustomer_num as ZcustomerNum,
    key zsales_orgnization as ZsalesOrgnization,
    ...
    //@Semantics.amount.currencyCode : 'ztab_clap1.zcurrency'
    zcurrency,
    ...
    zdistribution_channel as ZdistributionChannel,
    ...
    zprice_procedured_term as ZpriceProceduredTerm,
    ...
    zinvoicing_list_dates as ZinvoicingListDates,
    zinco_location1 as ZincoLocation1,
    zcredit_control_area as ZcreditControlArea,
    ...
    zrelationship_to_bp as ZrelationshipToBp
    
    
    
   
  /*  zbusiness_unit_name as ZbusinessUnitName,
    ztype_of_customer as ZtypeOfCustomer,
    zvertical as Zvertical,
    ztype_of_entity as ZtypeOfEntity,
    zline_business_type as ZlineBusinessType,
    zcustomer_legal_name as ZcustomerLegalName,
    zrequest_no as ZrequestNo,
